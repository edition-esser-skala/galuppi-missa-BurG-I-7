...
GratiasViolinoII = {
  \relative c' {
    ...
    r8 \parOn es\p-\parenthesize-! r es-! r f-! r \parOff f-\parenthesize-!
...
EtResurrexitViolinoII = {
  \relative c' {
    ...
    a4 r c8 c16 c c8 a
    f f16 f f8 c a16 f' f f f f f f
    g g g g g g g g a c c c f, c' c c
    d f f f c f f f b, f' f f a, f' f f
    ...
    e16 f g4 e,8 f f4 c'8
    a16 b c4 es,8 d4 r %285
    R1
    r8 cis'4 d16 e g, fis g4 g8
    ...
    cis,1
    cis?\fermata %305
    \tempoMortuorum r4 a,2\p a4
    a( g) \tempoEtVitam a4 r8 b'\f
