...
GratiasTenoreNotes = {
  \relative c' {
    ...
    R1*7 %286
    << { \oneVoice R1\fermata  } \\ { s2 \tempoPropter s } >>
...
EtIncarnatusIITenoreLyrics = \lyricmode {
